package com.zsq.SpringBootDemo.modules.test.entity;
...
public class Country {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") //json格式格式化
	@DateTimeFormat(pattern = "yyyy-MM-dd")  //springframework中的格式化
